...
#define CUSTOM_MACHINE_NAME "SJ5000"
...
#define HOTEND_OFFSET_Z { 0.00, 0.75 }  // (mm) relative Z-offset for each nozzle
...
#define PID_K1     0.95   // Smoothing factor within any PID loop
  ...
  #else
    #define DEFAULT_Kp 23.3459
    #define DEFAULT_Ki 1.4376
    #define DEFAULT_Kd 94.7843
  #endif
#else
 ...
 */
  ...
  #define MPC_BLOCK_HEAT_CAPACITY { 24.1152, 25.0532 }           // (J/K) Heat block heat capacities.
  #define MPC_SENSOR_RESPONSIVENESS { 0.1668, 0.2196 }         // (K/s per ∆K) Rate of change of sensor temperature from heat block.
  #define MPC_AMBIENT_XFER_COEFF { 0.0753, 0.0740 }           // (W/K) Heat transfer coefficients from heat block to room air with fan off.
  #if ENABLED(MPC_INCLUDE_FAN)
    #define MPC_AMBIENT_XFER_COEFF_FAN255 { 0.1321, 0.1130 }  // (W/K) Heat transfer coefficients from heat block to room air with fan on full.
  #endif
  ...
  #define FILAMENT_HEAT_CAPACITY_PERMM { 0, 0 }                                           // 0.0056 J/K/mm for 1.75mm PLA (0.0149 J/K/mm for 2.85mm PLA).
...
#define PIDTEMPBED
  ...
  #define DEFAULT_bedKp 39.8495
  #define DEFAULT_bedKi 7.1160
  #define DEFAULT_bedKd 148.7716
 ...
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 80, 80, 1600, 690, 690 }
 ...
 *                                      X, Y, Z [, I [, J [, K...]]], E0 [, E1[, E2...]]
 */
#define DEFAULT_MAX_FEEDRATE          { 500, 500, 10, 120, 120 }
 ...
 *                                      X, Y, Z [, I [, J [, K...]]], E0 [, E1[, E2...]]
 */
#define DEFAULT_MAX_ACCELERATION      { 10000, 10000, 500, 8000, 8000 }
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { 0, -32.50, 13.96 }   //FG offset for carrier probe
...
#define XY_PROBE_FEEDRATE    (167*60) // (mm/min)
...
#define Y_MAX_POS 365   //Y_BED_SIZE  //FG
