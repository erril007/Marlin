...
#define STRING_CONFIG_H_AUTHOR "Icke" // Who made the changes.
...
//#define ELECTROMAGNETIC_SWITCHING_TOOLHEAD
  ...
  #define SWITCHING_TOOLHEAD_X_POS          { 40, 120 }  // (mm) X positions for parking the extruders
...
#define PIDTEMPBED
  ...
  #define DEFAULT_bedKp 47.3030
  #define DEFAULT_bedKi 9.2389
  #define DEFAULT_bedKd 161.4610
...
#define Z_MIN_PROBE_ENDSTOP_HIT_STATE LOW     //FG
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { 50.60, 0, -2.50 }
...
#define X_MIN_POS -47.8 //-62.8mm
#define Y_MIN_POS 0
#define Z_MIN_POS 0
#define X_MAX_POS X_BED_SIZE
#define Y_MAX_POS 320.25 //Y_BED_SIZE
