...
#define HOTEND_OFFSET_Z { 0.0, 0.95 }  // (mm) relative Z-offset for each nozzle
 ...
 */
  ...
  #define MPC_BLOCK_HEAT_CAPACITY { 25.1995, 24.7630 }           // (J/K) Heat block heat capacities.
  #define MPC_SENSOR_RESPONSIVENESS { 0.2458, 0.1707 }         // (K/s per ∆K) Rate of change of sensor temperature from heat block.
  #define MPC_AMBIENT_XFER_COEFF { 0.0878, 0.0886 }           // (W/K) Heat transfer coefficients from heat block to room air with fan off.
  #if ENABLED(MPC_INCLUDE_FAN)
    #define MPC_AMBIENT_XFER_COEFF_FAN255 { 0.1553, 0.1615 }  // (W/K) Heat transfer coefficients from heat block to room air with fan on full.
  #endif
 ...
 *                                      X, Y, Z [, I [, J [, K...]]], E0 [, E1[, E2...]]
 */
#define DEFAULT_MAX_ACCELERATION      { 10000, 10000, 100, 8000, 8000 }
