...
#define FAST_PWM_FAN    // Increase the fan PWM frequency. Removes the PWM noise but increases heating in the FET/Arduino
  ...
  #define FAST_PWM_FAN_FREQUENCY 25000  //31400  // Define here to override the defaults below
...
#define FT_MOTION
  ...
  #define FTM_SHAPING_ZETA_X            0.03f    // Zeta used by input shapers for X axis
  #define FTM_SHAPING_V_TOL_X           0.05f   // Vibration tolerance used by EI input shapers for X axis

  #define FTM_DEFAULT_SHAPER_Y      ftMotionShaper_MZV // Default shaper mode on Y axis
  #define FTM_SHAPING_DEFAULT_FREQ_Y   26.5f    // (Hz) Default peak frequency used by input shapers
  #define FTM_SHAPING_ZETA_Y            0.03f    // Zeta used by input shapers for Y axis
 ...
 */
  ...
  #define PROBE_OFFSET_WIZARD
     ...
     */
    #define PROBE_OFFSET_WIZARD_START_Z 20
 ...
 */
  ...
  #define PROBE_PT_1 {  15, 0 }   // (mm) { x, y }
  #define PROBE_PT_2 {  300, 0 }
  #define PROBE_PT_3 { 150,  300 }
#endif
...
//#define PTC_HOTEND   // Compensate based on hotend temperature
   ...
   */
  #define PTC_LINEAR_EXTRAPOLATION 10
 ...
 */
  ...
  #define TOOLCHANGE_FILAMENT_SWAP
    ...
    #define TOOLCHANGE_FS_UNRETRACT_SPEED (120*60) // (mm/min) (On SINGLENOZZLE or Bowden loading must be slowed down)
